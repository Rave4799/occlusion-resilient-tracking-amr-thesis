...
| 2 | yolo_training/ | Done - mAP50=0.929 |
| 3 | rcnn_verifier/ | Done - loss 0.0508 |
| 4 | deepsort_tracking/ | Done - 14.2fps, 6 IDs |
| 5 | depth_estimation/ | Done - 8.11fps, 764 detections |
| 6 | verification_gate/ | Done - 291 safety events |
| 7 | llm_semantic_layer/ | Done - Gemini-2.5-Flash, 13/73 LLM calls |
| 8 | evaluation/ | Pending - July |
| 9 | ros2_integration/ | Pending - Jetson Orin, July |# Occlusion-Resilient Human Tracking and Safety Monitoring
# with Adaptive Logging using an LLM Semantic Layer
